...
const AppleIcon = () => (
    <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
        <path d="M12.152 6.896c-.948 0-2.415-1.078-3.96-1.04-2.04.027-3.91 1.183-4.961 3.014-2.117 3.675-.546 9.103 1.519 12.09 1.013 1.454 2.208 3.126 3.805 3.076 1.52-.05 2.118-.942 3.96-.942 1.815 0 2.353.942 3.96.904 1.656-.038 2.665-1.492 3.65-2.951 1.144-1.68 1.616-3.3 1.65-3.385-.035-.015-3.16-1.21-3.195-4.832-.031-3.033 2.52-4.522 2.63-4.582-1.408-2.067-3.606-2.353-4.4-2.42-2.05-.18-4.008 1.078-4.658 1.078M10.92 4.328c.84-.997 1.4-2.375 1.246-3.76-.108-.01-.252-.027-.396-.027-1.348 0-2.784.887-3.657 1.905-.758.877-1.42 2.278-1.233 3.633 1.48.115 2.922-.72 3.918-1.72" />
    </svg>
);

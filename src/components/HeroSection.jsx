        ...
        <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden bg-white dark:bg-gray-950 transition-colors">
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
                <div className="text-center max-w-4xl mx-auto">
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 dark:bg-blue-900/30 border border-blue-100 dark:border-blue-800 text-primary text-sm font-medium mb-8">
                    ...
                    <p className="mt-6 text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto mb-10 leading-relaxed">
                    ...
                    <p className="mt-4 text-sm text-gray-500 dark:text-gray-500 font-medium">14-day free trial • Card required to activate sync</p>
                </div>

                {/* Abstract Hero Image / Visualization */}
                <div className="mt-20 relative mx-auto max-w-5xl perspective-1000">
                    <div className="relative rounded-2xl lg:rounded-[2rem] bg-gray-900/5 dark:bg-white/5 p-2 lg:p-4 backdrop-blur-3xl border border-gray-200/50 dark:border-gray-700/50 shadow-2xl transform rotate-x-6 hover:rotate-x-0 transition-transform duration-700 ease-out">
                        <div className="bg-white dark:bg-gray-900 rounded-xl lg:rounded-3xl border border-gray-100 dark:border-gray-800 overflow-hidden shadow-sm flex flex-col md:flex-row">

                            {/* Fake Gmail UI segment */}
                            <div className="w-full md:w-5/12 border-b md:border-b-0 md:border-r border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-800/50 p-6 flex flex-col">
                                ...
                                <div className="space-y-3 relative">
                                    {[1, 2, 3].map((i) => (
                                        <div key={i} className="bg-white dark:bg-gray-800 p-4 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 flex gap-3 relative z-10">
                                    ...
                                    <svg className="absolute top-1/2 -right-8 w-24 h-12 text-primary z-20 hidden md:block" style={{ transform: 'translateY(-50%)' }} fill="none" viewBox="0 0 100 50">
                                        ...
                                        <circle cx="50" cy="25" r="12" fill="white" stroke="currentColor" strokeWidth="2" className="dark:fill-gray-900" />
                            ...
                            <div className="w-full md:w-7/12 bg-white dark:bg-gray-900 p-6 flex flex-col">
                                <div className="flex items-center gap-3 mb-6 pb-4 border-b border-gray-100 dark:border-gray-700">
                                    ...
                                    <div className="ml-auto flex gap-2">
                                        <span className="px-2 py-1 bg-gray-100 dark:bg-gray-800 rounded text-xs text-gray-600 dark:text-gray-400 font-medium">Filter</span>
                                                ...
                                                <tr key={i} className="border-b border-gray-50 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                                                    <td className="py-4 font-medium flex items-center gap-2">
                                                        <span className="w-4 h-4 rounded border border-gray-200 dark:border-gray-600 flex items-center justify-center">
                                                            <span className="w-2 h-2 rounded-sm bg-gray-200 dark:bg-gray-600"></span>
                                                        </span>
                                                        {row.n}
                                                    </td>
                                                    <td className="py-4">

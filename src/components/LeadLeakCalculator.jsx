        ...
        <section className="py-24 bg-gray-50 dark:bg-gray-900 border-y border-gray-100 dark:border-gray-800 transition-colors">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-col lg:flex-row gap-12 items-center">
                    ...
                    {/* Calculator Inputs */}
                    <div className="w-full lg:w-1/2 bg-white dark:bg-gray-800 p-8 rounded-[2rem] shadow-xl border border-gray-100 dark:border-gray-700 relative">
                        <div className="absolute -top-6 -right-6 w-24 h-24 bg-red-100 dark:bg-red-900/30 rounded-full mix-blend-multiply dark:mix-blend-normal opacity-50 blur-2xl"></div>
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="pt-6 border-t border-gray-100 dark:border-gray-700">
                                <div className="bg-red-50 dark:bg-red-900/20 rounded-2xl p-6 text-center border border-red-100 dark:border-red-800">
                    ...
                    <div className="w-full lg:w-1/2 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-6">
                        <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm flex items-start gap-4">
                            <div className="p-3 bg-orange-50 dark:bg-orange-900/30 text-orange-500 rounded-xl flex-shrink-0">
                        ...
                        <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm flex items-start gap-4">
                            <div className="p-3 bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400 rounded-xl flex-shrink-0">
                        ...
                        <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm flex items-start gap-4">
                            <div className="p-3 bg-red-50 dark:bg-red-900/30 text-red-500 rounded-xl flex-shrink-0">

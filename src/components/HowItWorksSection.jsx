            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="relative">
                    ...
                    <div className="hidden md:block absolute top-12 left-[15%] right-[15%] h-0.5 bg-gray-100 -z-10">
                        <div className="absolute top-0 left-0 h-full w-full bg-gradient-to-r from-blue-100 via-primary to-blue-100 opacity-20"></div>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
                        {steps.map((step, index) => (
                            <div key={index} className="relative flex flex-col items-center text-center">
                                <div className="w-24 h-24 bg-white rounded-3xl border-2 border-primary/20 shadow-xl shadow-blue-500/10 flex items-center justify-center mb-8 relative z-10 group hover:border-primary transition-colors duration-300">
